...
const CLAIM_CONTRACT: &str = "ssd_claim";
const HOLDING_STUB_CONTRACT: &str = "exploit_stub";
const FT_CONTRACT: &str = "ssd";
...
pub async fn prepare_contract() -> Result<Context> {
    ...
    context.ft_contract().new(alice.clone(),U128(10000000000000)).await?;
    ...
    context
        .ft_contract()
        .storage_deposit(Some(alice.clone()), None)
        .await?;
